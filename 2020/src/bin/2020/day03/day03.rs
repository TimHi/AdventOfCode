...
fn main() {
    ...
    let input = file_handler::read_lines_from_file(
        "C:/Users/TimHi/Documents/GitHub/AdventOfCode/2020/src/bin/2020/day03/input/input.txt",
    );
    println!("Day 03 Part 01: {}", check_trees(input.clone(), 1, 3));
    println!("Part 01 Time elapsed: {:?}", start.elapsed());
    let part_two: i64 = (check_trees(input.clone(), 1, 1)
        * check_trees(input.clone(), 1, 3)
        * check_trees(input.clone(), 1, 5)
        * check_trees(input.clone(), 1, 7)
        * check_trees(input.clone(), 2, 1)) as i64;
    println!("Day 03 Part 02: {}", part_two);
    println!("Part 02 Time elapsed: {:?}", start.elapsed());
}
